# 名称定義
$resourceGroupName = "ksapElCatalogGroup"
$resourceGroupNameApp = $resourceGroupName
$storageAccountName = "ksapelstorageaccount"
$region = "japaneast"
$appContainerName = "ksaelpcontainer"
$azureADGroupName = "CatalogADGroup"
$role = "Owner"
$managedApplicationDefinitionName = "ksapElasticApp"
